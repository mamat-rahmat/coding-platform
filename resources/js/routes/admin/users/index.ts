...
* @see app/Http/Controllers/AdminUserController.php:45
...
* @see app/Http/Controllers/AdminUserController.php:64
* @route '/admin/users/{user}'
*/
...
* @see app/Http/Controllers/AdminUserController.php:75
