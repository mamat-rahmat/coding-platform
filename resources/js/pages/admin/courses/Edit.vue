...
const form = reactive({
    ...
    xp_reward: props.course.xp_reward,
...
function submit() {
    router.put(adminCourseRoutes.update.url(props.course.id), form, {
...
<template>
    ...
    <div class="mx-auto max-w-2xl p-4">
        ...
        <h1 class="mb-6 text-2xl font-bold tracking-tight">Edit Course</h1>
                ...
                <form class="space-y-4" @submit.prevent="submit">
                    ...
                    <div class="flex gap-2 pt-4">
                        ...
                        <Button as-child variant="outline">
                            <Link :href="adminCourseRoutes.show.url(course.id)">
                                Batal
                            </Link>
                        </Button>
                    </div>
