...
function submit() {
    router.post(
        adminLessonRoutes.store.url({ module: props.module.id }),
        form,
        {
...
<template>
    <Head title="Admin - Lesson Baru" />

    <div class="mx-auto max-w-2xl p-4">
        <Link
            :href="adminLessonRoutes.index.url({ module: module.id })"
        ...
        <h1 class="mb-6 text-2xl font-bold tracking-tight">Lesson Baru</h1>
